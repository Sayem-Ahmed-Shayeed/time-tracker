...
export function Showpiece3D() {
  ...
  return (
    <section className="surface-elevated relative flex flex-col overflow-hidden" style={{ background: '#000' }} aria-label="3D showpiece">
      <div ref={hostRef} className="relative min-h-64 w-full flex-1 sm:min-h-72" />
    </section>
  )
}